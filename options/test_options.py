...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument("--result_ulf", type=str, default=result_path, help="Path to save the result NIfTI file")
        parser.add_argument("--result_sr", type=str, default=result_path, help="Path to save the result NIfTI file")
